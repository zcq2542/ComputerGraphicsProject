...
vec4 HeadLight(){
    ...
    if(u_HeadLightOn != 0){
        ...
        //if(angle < 0.4){
            ...
            diffuse = 0.8 * attenuation * headLightStren * u_HeadLightCol * (diff) * colorDiffuse ;
...
void main()
{
    ...
    //if(fragPos.x > 0){  fragColor.r = 1;}
    //if(fragPos.y > 0){  fragColor.g = 1;}
    //if(fragPos.z > 0){  fragColor.b = 1;}
